...
### Example Workflow:
1. Select option `2` for a Custom QR Code.
2. Enter your URL (e.g., `https://github.com`).
3. Press `Enter` to use default sizing, or specify numbers for box size and border.
4. Enter colors (e.g., `blue` for fill, `white` for background).
5. Specify an output filename (e.g., `github_qr.png`).
6. The image will be saved directly in your current working directory.